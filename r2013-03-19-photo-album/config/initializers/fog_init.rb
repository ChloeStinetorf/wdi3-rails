...
CarrierWave.configure {|config| config.fog_directory = 'album-chloe-test'} if Rails.env.development?
CarrierWave.configure {|config| config.fog_directory = 'album-chloe-test'} if Rails.env.test?
