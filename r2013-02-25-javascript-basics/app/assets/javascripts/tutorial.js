...
while(response != 'q') {
  ...
  {
    case 's':
      var squared = square(get_number('enter your number to square?'));
      console.log('the number squared is: ' + squared)
      break;
    case 'c':
      var cubed = cube(get_number('enter your number to cube?'));
      console.log('the number cubed is: ' + cubed)
      break;
    case 'a':
      var area = length(get_number('enter length?'));
      var area = width(get_number('enter width?'));
